...
# ---------------------------------------------------------------------------
# SOURCE: Windows Server 2016 Desktop on Hyper-V
# ---------------------------------------------------------------------------

source "hyperv-iso" "windows_server_2016_desktop" {
  vm_name = join(
    "-",
    [
      "build",
...
build {
  name    = "windows_server_2016_desktop"
  sources = ["source.hyperv-iso.windows_server_2016_desktop"]

  # -------------------------------------------------------------------------
  # Remove Internet Explorer
  # -------------------------------------------------------------------------
  provisioner "powershell" {
    scripts = ["provisioning/post-build/Remove-InternetExplorer.ps1"]
  }
