...
# ---------------------------------------------------------------------------
# SOURCE: Windows Server 2025 Core on Hyper-v
# ---------------------------------------------------------------------------

source "hyperv-iso" "windows_server_2025_core" {
  vm_name = join(
    "-",
    [
      "build",
...
build {
  name    = "windows_server_2025_core"
  sources = ["source.hyperv-iso.windows_server_2025_core"]
